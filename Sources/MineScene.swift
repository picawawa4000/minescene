...
final class MineSceneApp {
    ...
    init() throws {
        ...
        if debugBlockstatesEnabled || structureViewerEnabled {
            ...
            let generatedWorld = try makeWorldGenerator(seed: seed, noiseSettingsKey: currentNoiseSettingsKey)
    ...
    private func makeOceanMonumentStructureViewer() throws -> OceanMonumentStructureViewer {
        ...
        let worldGenerator = try makeWorldGenerator(seed: structureSeed, noiseSettingsKey: defaultNoiseSettingsKey)
